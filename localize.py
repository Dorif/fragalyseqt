...
#Well, some systems like FreeBSD may have C or POSIX locale. Or no locale set, like OpenBSD.
    if ("en" or "C.UTF-8" or "POSIX") in lang or lang == None:
        iface['ch_inact_msg'] = "Inactive channel"
        iface['aboutbtn'] = "About"
        iface['infoboxtxt'] = "FragalyseQt version 0.3.1, codename \"DiGeorge\".\n\nThis program version supports analysis of up to 8 different fluorescense channels simultaneously, selective channel hiding, non-Latin run names and can correctly handle damaged files, exporting peaks locations, areas, FWHM's and channel names in CSV for any *.FSA/*.HID files and export in CSV internal analysis data for *.FSA/*.HID files generated by ABI 3500 and SeqStudio series equipment.\n\nPeaks areas are calculated assuming they are Gaussian peaks.\n\nLicensed under GNU GPL version 3.\n\nIf you wish to contact author for any reason - please write at dorif11@gmail.com"
