...
# Or no locale set, like OpenBSD.
    if lang is None or any(token in lang for token in ("en", "C.UTF-8", "POSIX")):
        ...
        iface['infoboxtxt'] = "FragalyseQt version 0.4.3, codename\"Jeffreys"\
        ...
        iface['infoboxtxt'] = "FragalyseQt версия 0.4.3, кодовое имя "\
        ...
        iface['infoboxtxt'] = "FragalyseQt версія 0.4.3, кодове ім'я "\
        ...
        iface['infoboxtxt'] = "FragalyseQt versiune 0.4.3, codename "\
        ...
        iface['infoboxtxt'] = "FragalyseQt version 0.4.3, alias "\
        ...
        iface['infoboxtxt'] = "FragalyseQt версия 0.4.3, кодово име \"Джефрис"\
