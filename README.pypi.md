...
<img src="https://raw.githubusercontent.com/Dorif/fragalyseqt/v0.5.4/FragalyseQt.png" width="100" height="100">

## What's this?

It is software for fragment analysis (MLPA, QF-PCR etc.) data processing.

<img src="https://raw.githubusercontent.com/Dorif/fragalyseqt/v0.5.4/FragalyseQt_current_interface.png">
...
Install FragalyseQt with one supported Qt binding:

```bash
python -m pip install "fragalyseqt[pyqt6]"
fragalyseqt
```

`pyqt5` and `pyside6` extras are also available. Maintainers can find the
build, TestPyPI and Trusted Publishing procedure in [RELEASING.md](https://github.com/Dorif/fragalyseqt/blob/v0.5.4/RELEASING.md).
